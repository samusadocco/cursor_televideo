...
class TelevideoEvent with _$TelevideoEvent {
  const factory TelevideoEvent.loadNationalPage(int pageNumber, {@Default(false) bool forceRefresh}) = _LoadNationalPage;
  const factory TelevideoEvent.loadRegionalPage(Region region, int pageNumber, {@Default(false) bool forceRefresh}) = _LoadRegionalPage;
