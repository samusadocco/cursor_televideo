...
class TeletextChannels {
  static final List<TeletextChannel> allChannels = [
   ...
   // 🇩🇪 ARTE (Germania) - Piattaforma Zattoo con OCR
    ...
    TeletextChannel(
      id: 'tvp1_telegazeta',
      name: 'TVP1 Telegazeta',
      shortName: 'TVP1',
      countryCode: 'PL',
      flagEmoji: '🇵🇱',
      broadcasterName: 'TVP',
      type: TeletextChannelType.national,
      baseUrl: 'https://telegazeta.pl/89753282/sg-tvp1',
      htmlBaseUrl: 'https://telegazeta.pl/89753282/sg-tvp1?page=100_0001',
      supportsRegions: false,
    ),
    TeletextChannel(
      id: 'tvp2_telegazeta',
      name: 'TVP2 Telegazeta',
      shortName: 'TVP2',
      countryCode: 'PL',
      flagEmoji: '🇵🇱',
      broadcasterName: 'TVP',
      type: TeletextChannelType.national,
      baseUrl: 'https://telegazeta.pl/89819773/sg-tvp2',
      htmlBaseUrl: 'https://telegazeta.pl/89819773/sg-tvp2?page=100_0001',
      supportsRegions: false,
    ),
    TeletextChannel(
      id: 'tvp3_telegazeta',
      name: 'TVP3 Telegazeta',
      shortName: 'TVP3',
      countryCode: 'PL',
      flagEmoji: '🇵🇱',
      broadcasterName: 'TVP',
      type: TeletextChannelType.national,
      baseUrl: 'https://telegazeta.pl/89821025/sg-tvp3',
      htmlBaseUrl: 'https://telegazeta.pl/89821025/sg-tvp3?page=100_0001',
      supportsRegions: false,
    ),
    TeletextChannel(
      id: 'tvp_kultura_telegazeta',
      name: 'TVP Kultura Telegazeta',
      shortName: 'TVP Kultura',
      countryCode: 'PL',
      flagEmoji: '🇵🇱',
      broadcasterName: 'TVP',
      type: TeletextChannelType.national,
      baseUrl: 'https://telegazeta.pl/89821085/sg-tvp-kultura',
      htmlBaseUrl: 'https://telegazeta.pl/89821085/sg-tvp-kultura?page=100_0001',
      supportsRegions: false,
    ),
    TeletextChannel(
      id: 'tvp_historia_telegazeta',
      name: 'TVP Historia Telegazeta',
      shortName: 'TVP Historia',
      countryCode: 'PL',
      flagEmoji: '🇵🇱',
      broadcasterName: 'TVP',
      type: TeletextChannelType.national,
      baseUrl: 'https://telegazeta.pl/89821192/sg-tvp-historia',
      htmlBaseUrl: 'https://telegazeta.pl/89821192/sg-tvp-historia?page=100_0001',
      supportsRegions: false,
    ),
    TeletextChannel(
      id: 'tvp_sport_telegazeta',
      name: 'TVP Sport Telegazeta',
      shortName: 'TVP Sport',
      countryCode: 'PL',
      flagEmoji: '🇵🇱',
      broadcasterName: 'TVP',
      type: TeletextChannelType.national,
      baseUrl: 'https://telegazeta.pl/89821259/sg-tvp-sport',
      htmlBaseUrl: 'https://telegazeta.pl/89821259/sg-tvp-sport?page=100_0001',
      supportsRegions: false,
    ),
    TeletextChannel(
      id: 'tvp_polonia_telegazeta',
      name: 'TVP Polonia Telegazeta',
      shortName: 'TVP Polonia',
      countryCode: 'PL',
      flagEmoji: '🇵🇱',
      broadcasterName: 'TVP',
      type: TeletextChannelType.national,
      baseUrl: 'https://telegazeta.pl/89821790/sg-tvp-polonia',
      htmlBaseUrl: 'https://telegazeta.pl/89821790/sg-tvp-polonia?page=100_0001',
      supportsRegions: false,
    ),
