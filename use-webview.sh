...
echo "📄 [1/7] Copiando polsat_provider.webview.dart..."
...
echo "📄 [1b/7] Copiando zattoo_ocr_service.google.dart..."
...
# 1c. Copia stub OCR Polsat/Telegazeta (senza ML Kit)
echo "📄 [1c/7] Copiando mlkit_polsat_ocr_service.webview.dart..."
cp lib/core/ocr/_versions/mlkit_polsat_ocr_service.webview.dart \
   lib/core/ocr/mlkit_polsat_ocr_service.dart
echo "   ✅ OCR stub WebView attivato"

# 1d. Copia stub IAP (senza in_app_purchase)
echo "📄 [1d/7] Copiando iap_service.webview.dart..."
cp lib/core/iap/_versions/iap_service.webview.dart \
   lib/core/iap/iap_service.dart
echo "   ✅ IAP stub WebView attivato"

# 2. Copia pubspec.yaml senza ML Kit
echo "📦 [2/7] Copiando pubspec.yaml senza ML Kit..."
...
echo "   - Telegazeta/TVP: OCR disabilitato (link da HTML map)"
echo "   - IAP: stub (acquisti non disponibili su simulatore)"
echo ""
